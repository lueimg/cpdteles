    ...
    Equivalencia: function() {
        var gridC = $('#table_hora').jqGrid({
            ...
            colModel: [
                ...
                {name: 'dtitulo', index: 'dtitulo', align: 'left', width: 120, editable: true, editrules: {required: true}, sorttype: "text"},
                {name: 'ccurric', index: 'ccurric', align: 'left', width: 120, editable: true, editrules: {required: true}, sorttype: "text", hidden: true},
                ...
                {name: 'ccurso', index: 'ccurso', align: 'left', width: 120, editable: true, editrules: {required: true}, sorttype: "text", hidden: true},
                {name: 'dtituloa', index: 'dtituloa', align: 'center', width: 120, editable: true, editrules: {required: true}, sorttype: "text"}, //" : , para coger todos los valores 1 y 0, campo required lo interpreta en blanco"
                {name: 'ccurrica', index: 'ccurrica', align: 'left', width: 120, editable: true, editrules: {required: true}, sorttype: "text", hidden: true},
                ...
                {name: 'dcursoa', index: 'dcursoa', align: 'center', width: 120, editable: true, editrules: {required: true}, sorttype: "text"}, //" : , para coger todos los valores 1 y 0, campo required lo interpreta en blanco"
                {name: 'ccursoa', index: 'ccursoa', align: 'left', width: 120, editable: true, editrules: {required: true}, sorttype: "text", hidden: true},
                {name: 'estide', index: 'estide', align: 'left', width: 60, editable: true, editrules: {required: true}, stype: "select", edittype: "select", editoptions: {value: " : ;r:Regular;i:Irregular"}},
            ],
            rowNum: 15,
            //rowList:[5,10],
            rownumbers: true,
