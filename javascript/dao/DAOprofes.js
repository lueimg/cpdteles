var profesDAO = {
    ...
    $.ajax({
            ...
            data : {
            comando:this.comando,
             action:'InsertarDocente',
             accion:'InsertarDocente',
                post:{
            ...
            success : function ( obj ) {
                 sistema.cierraCargando();
                if(obj.rst=='1'){
                    $('#frmProfes').dialog('close');
                    $("#table_docente").trigger('reloadGrid');
                    sistema.msjOk(obj.msj);
    ...
    ActualizarDocente:function(){
        $.ajax({
            ...
            data : {
            comando:this.comando,
             action:'ActualizarDocente',
             accion:'ActualizarDocente',
                post:{
                  cprofes:$('#cprofes').val(),
                  cfilial:$('#slct_filial').val(),
                  cinstit :$('#slct_instituto').val(),
