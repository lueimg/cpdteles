...
//validacion para saber si estamos en la pagina profesHorarios
...
Exportar_grilla = function (){
    
    var grupos = $('#table_docente').jqGrid('getGridParam','selarrrow');
    var lista_grupos = grupos.join(',');
    window.open('../reporte/pdf/PDFProfesHorarioGrilla.php?'+ "docentes="+lista_grupos , "_blank");   
