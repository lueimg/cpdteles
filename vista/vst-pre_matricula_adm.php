...
<html>
	...
	<script type="text/javascript" src="../javascript/dao/DAOcarrera.js"></script>
		...
		<script type="text/javascript" src="../javascript/js/js-pre_matricula_adm.js"></script>
			...
			<div class="cuerpo">
				<div class="secc-izq" id="secc-izq" style="width:0px;">
					<ul class="lca" style="display:none">
						<li id="list_matricula" onclick="sistema.activaPanel('list_matricula','panel_matricula')" class="active"><span><i class="icon-gray icon-list-alt"></i> PRE MATRICULA ADM <? /*aquui va el menu q se carga en la izquierda*/ ?> </span></li>						
					</ul>
				</div>
				...
				<div class="secc-der" id="secc-der">
                    ...
                    <div id="panel_matricula" style="display:block">
                        <div class="barra1"><i class="icon-gray icon-list-alt"></i> <b>PRE MATRICULA ADM <?   /*aqui va el titulo q presentara  */ ?></b></div>         
                        <div class="cont-der">
							<div class="t-center">
                                ...
                                <table style="width:90%">
                                       <tr> 
                                        ...
                                        <tr>
                                            ...
                                            <td class="t-left">
                                                <select id="slct_ciclo" class="input-medium" disabled><option value="">--Selecione--</option></select>
                                            </td>
                                       </tr>   
                                       <tr>
                                ...
                                <div id="v_lista_alumnos" style="display:none; width:700px">
                                    ...
                                    <table>
                                        <tr class="" align="center">
                                        	<td class="t-center label" ><input id="checkall" type="checkbox" onChange="sistema.checkall('lista_alumnos','checkall')"></td>                                            
                                    ...
                                    <table id="btn_alumnos" cellspacing="1" cellpadding="1" border="1"> </table>
                                    </div>
                                    <div class="corner_bottom ui-state-default" style="text-align: right;height: 20px;padding: 2px;">
