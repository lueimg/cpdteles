				...
				<div class="secc-der" id="secc-der">
                    ...
                    <div id="panel_buscar_alu" style="display:block">
                        ...
                        <div class="cont-der">
                            ...
                            <div class="barra4 contentBarra t-blanco"><i class="icon-white icon-th"></i> ESCALA DEL ALUMNO</div>
                        	<br>
                        	<table cellspacing="1" cellpadding="2" border="0" style="table-layout:fixed;" class="EditTable">
                              ...
                              <tr class="FormData">
                              	<td class="t-left label">
                              		<b>Escala del Alumno</b>                              		
                              	</td>
                              	<td class="t-left">
                              	  <div id="div_escala"></div>
                                  <input type="hidden" id="txt_escala">
                                </td>
                                <td class="t-left label">
                              		<b>Monto Pagado del Alumno</b>                              		
                              	</td>
                              	<td class="t-left">
                              	  <div id="div_monto_escala"></div>
                                  <input type="hidden" id="txt_monto_escala">
                                </td>                                     
                              </tr>
                              <tr>
                              	<td class="t-left label">
                              		<b>Seleccione nueva Escala</b>                              		
                              	</td>
                              	<td class="t-left">
                              		<select id='slct_escala'>
                              ...
                              <tr class="FormData">
                              	<td>
                              		<div style="margin:15px 0px 10px 0px;">
	                                    <a id="btn_cambiar_escala" onClick="CambiarEscala();" class="btn btn-azul sombra-3d t-blanco" href="javascript:void(0)">
