...
<html>
	<head>
		...
		<script src="../javascript/jqGrid/JQGridHora.js"></script>
        <script src="../javascript/dao/DAOinstitucion.js"></script>
        <script src="../javascript/dao/DAOcarrera.js"></script>
        <script src="../javascript/dao/DAOHora.js"></script>
        <script src="../javascript/js/js-mant_Hora.js"></script>
			...
			<div class="cuerpo">
				...
				<div class="secc-der" id="secc-der">
                    ...
                    <div id="panel_matricula" style="display:block">
    					<div class="barra1"><i class="icon-gray icon-list-alt"></i> <b>Mantenimiento Horas <? /*aqui va el titulo q presentara  */ ?></b></div>         
                        <div class="cont-der">
			<? /*
							*/  ?>
                            <div>
