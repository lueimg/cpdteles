...
class MySqlPersonaDAO{
    ...
    $valsql=$db->loadObjectList();
		...
		$sql="Insert Into vendedm (cfilial,cvended,dnombre,dapepat,dapemat,ndocper,demail,tdocper,fingven,tsexo,coddpto,codprov,coddist,ddirecc,tvended,cinstit,codintv,dtelefo,fusuari,cusuari,ttiptra,cestado,copeven)
	...
	$sql="	select v.cfilial,v.cvended,v.dnombre,v.dapepat,v.dapemat,v.demail,v.dtelefo,v.ndocper,
			v.tdocper,v.fingven,v.tsexo,v.coddpto,v.codprov,v.coddist,
