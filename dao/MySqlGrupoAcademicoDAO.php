...
# OBTENIENDO DATA CURSOS
$cursos = explode(',', $lista_cursos);
$data_cursos = array();

foreach ($cursos as $curso) { 
$sql = "select cup.ccuprpr, cur.dcurso from cuprprp cup
inner join cursom cur on cur.ccurso = cup.ccurso
where cup.ccuprpr = $curso";
// print($sql);die();
...
EOD;
  ...
  public function GAGetHorarioGeneral($array){
  		$db=creadorConexion::crear('MySql');
  		$lista_cursos = $array['cursos'];


# como aun no enviamos las secciones 
# no filtraremos por seccion
